        ...
        <table className = "list">
          ...
          </thead>
          {
            this.state.data_list ? 
              this.state.data_list
              .filter(item => item.activity_name.toLowerCase().includes(this.state.nume_activitate.toLowerCase()) && item.day.toLowerCase().includes(this.state.data.toLowerCase())
               ...
               && item.time_interval.includes(this.state.interval))
               .map(item => 
                {return(
                  <tbody>
                    <tr>
